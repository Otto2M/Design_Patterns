...
import org.foi.uzdiz.omilermat.zadaca_3.state.StateAktivno;
import org.foi.uzdiz.omilermat.zadaca_3.state.VoziloState;
import org.foi.uzdiz.omilermat.zadaca_3.visitor.Visitable;
import org.foi.uzdiz.omilermat.zadaca_3.visitor.VoziloVisitor;

public class Vozilo implements Visitable, Prototype<Vozilo> {
  ...
  public String toString() {
    return registracija + "; " + opis + "; " + tezina + " kg; " + kapacitet + " m3; " + redoslijed
        + "; " + prosjecnaBrzina + "; " + podrucjaPoRangu + "; " + statusVozila;
  }
  ...
  @Override
  public Vozilo cloneP() throws CloneNotSupportedException {
    Vozilo kloniranoVozilo =
        new Vozilo(this.registracija, this.opis, this.tezina, this.kapacitet, this.redoslijed,
            this.statusSlobodno, this.prosjecnaBrzina, this.podrucjaPoRangu, this.statusVozila);
    return kloniranoVozilo;
  }
